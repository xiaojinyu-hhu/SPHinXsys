...
Real dp_0 = (domain_upper_bound[0] - domain_lower_bound[0]) / 40;
...
int main(int ac, char *av[])
{
    ...
    //----------------------------------------------------------------------
    BodyStatesRecordingToVtu write_imported_model_to_vtpstring({imported_model});
    //BodyStatesRecordingToVtp write_imported_model_to_vtp({imported_model});

    write_imported_model_to_vtpstring.addToWrite<Real>(imported_model, "SmoothingLengthRatio");
    //write_imported_model_to_vtpstring.addToWrite<float>(imported_model, "mass");
    //write_imported_model_to_vtpstring.addToWrite<int>(imported_model, "type");
    //write_imported_model_to_vtpstring.addToWrite<int>(imported_model, "group");
    //write_imported_model_to_vtpstring.addToWrite<float>(imported_model, "rho");

    //BaseParticles &base_particles = imported_model.getBaseParticles();
    //size_t total_real_particles = base_particles.TotalRealParticles();
    //ParticleVariables &variables_to_write = base_particles.VariablesToWrite();
    ...
    write_imported_model_to_vtpstring.writeToFile();
    ...
    while (ite_p < 1000)
    {
        ...
        if (ite_p % 100 == 0)
        {
            ...
            write_imported_model_to_vtpstring.writeToFile(ite_p);
