...
//	Basic geometry parameters and numerical setup.
//----------------------------------------------------------------------
Real DL = 0.03; // Domain width.
Real DH = 0.4;  // Domain height.
Real DW = 0.1;  // Domain width.
Vec3d domain_lower_bound(-0.03, 0, -0.1);
...
int main(int ac, char *av[])
{
    ...
    //----------------------------------------------------------------------
    sph_system.addRealBody(&imported_model);
    ...
    write_imported_model_to_vtpstring.writeToFile(0.0);   
